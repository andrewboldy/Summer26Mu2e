...
namespace mu2e {
  ...
  public:
    ...
    enum enum_type {
      ...
      mu2eFlatMuMinus, mu2eFlatMuPlus, Mu2eX, mu2eCeEndpointDiffEnergy, mu2eCeEndpointDiffEnergyB2B, // 196
      lastEnum,
...
#define PROCESSCODE_NAMES                                                                                   \
  ...
  "mu2eCePlusLeadingLog", "mu2ePionCaptureAtRest", "mu2eExternalRPC", "mu2eInternalRPC", \
    "mu2eCaloCalib", "mu2ePienu", "CoupledTransportation", "mu2eunused8", \
      ...
      "mu2eFlatMuMinus", "mu2eFlatMuPlus", "Mu2eX", "mu2eCeEndpointDiffEnergy", "mu2eCeEndpointDiffEnergyB2B"
#endif
